...
# Board skews
set board(abs_max_CK_delay) 0.00444424
set board(abs_max_DQS_delay) 0.0040105
set board(minCK_DQS_skew) 0.0
set board(maxCK_DQS_skew) 0.0013574
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 3.085E-4
set board(inter_DQS_group_skew) 0.0040105
set board(DQ_DQS_skew) -7.60938E-6
set board(intra_addr_ctrl_skew) 3.085E-5
set board(addresscmd_CK_skew) -1.5425E-5
