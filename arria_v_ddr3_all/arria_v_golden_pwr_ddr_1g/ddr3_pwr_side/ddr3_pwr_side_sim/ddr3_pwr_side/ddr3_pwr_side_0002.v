...
module ddr3_pwr_side_0002 (
	...
	wire   [23:0] m0_phy_mux_afi_wdata_valid;                  // m0:phy_mux_wdata_valid -> p0:afi_wdata_valid
	wire  [383:0] p0_afi_afi_rdata;                            // p0:afi_rdata -> m0:phy_mux_rdata
	wire  [383:0] m0_phy_mux_afi_wdata;                        // m0:phy_mux_wdata -> p0:afi_wdata
	wire    [3:0] m0_phy_mux_afi_rst_n;                        // m0:phy_mux_rst_n -> p0:afi_rst_n
	wire   [23:0] m0_phy_mux_afi_dqs_burst;                    // m0:phy_mux_dqs_burst -> p0:afi_dqs_burst
	...
	wire   [47:0] m0_phy_mux_afi_dm;                           // m0:phy_mux_dm -> p0:afi_dm
	...
	wire  [383:0] m0_afi_afi_rdata;                            // m0:afi_rdata -> c0:afi_rdata
	...
	wire   [47:0] s0_scc_scc_dq_ena;                           // s0:scc_dq_ena -> p0:scc_dq_ena
	wire    [0:0] s0_scc_scc_upd;                              // s0:scc_upd -> p0:scc_upd
	wire    [5:0] s0_scc_scc_dqs_io_ena;                       // s0:scc_dqs_io_ena -> p0:scc_dqs_io_ena
	wire    [5:0] s0_scc_scc_dm_ena;                           // s0:scc_dm_ena -> p0:scc_dm_ena
	wire    [5:0] p0_scc_capture_strobe_tracking;              // p0:capture_strobe_tracking -> s0:capture_strobe_tracking
	wire    [5:0] s0_scc_scc_dqs_ena;                          // s0:scc_dqs_ena -> p0:scc_dqs_ena
	...
	wire   [23:0] s0_afi_afi_wdata_valid;                      // s0:afi_wdata_valid -> m0:seq_mux_wdata_valid
	wire  [383:0] m0_seq_mux_afi_rdata;                        // m0:seq_mux_rdata -> s0:afi_rdata
	wire  [383:0] s0_afi_afi_wdata;                            // s0:afi_wdata -> m0:seq_mux_wdata
	wire    [3:0] s0_afi_afi_rst_n;                            // s0:afi_rst_n -> m0:seq_mux_rst_n
	wire   [23:0] s0_afi_afi_dqs_burst;                        // s0:afi_dqs_burst -> m0:seq_mux_dqs_burst
	wire   [51:0] s0_afi_afi_addr;                             // s0:afi_addr -> m0:seq_mux_addr
	wire   [11:0] s0_afi_afi_ba;                               // s0:afi_ba -> m0:seq_mux_ba
	wire   [47:0] s0_afi_afi_dm;                               // s0:afi_dm -> m0:seq_mux_dm
	...
	wire    [5:0] s0_phy_phy_read_increment_vfifo_qr;          // s0:phy_read_increment_vfifo_qr -> p0:phy_read_increment_vfifo_qr
	wire    [5:0] s0_phy_phy_vfifo_rd_en_override;             // s0:phy_vfifo_rd_en_override -> p0:phy_vfifo_rd_en_override
	wire    [5:0] s0_phy_phy_read_fifo_reset;                  // s0:phy_read_fifo_reset -> p0:phy_read_fifo_reset
	wire   [11:0] s0_phy_phy_write_fr_cycle_shifts;            // s0:phy_write_fr_cycle_shifts -> p0:phy_write_fr_cycle_shifts
	...
	wire    [5:0] s0_phy_phy_read_increment_vfifo_hr;          // s0:phy_read_increment_vfifo_hr -> p0:phy_read_increment_vfifo_hr
	wire    [5:0] s0_phy_phy_read_increment_vfifo_fr;          // s0:phy_read_increment_vfifo_fr -> p0:phy_read_increment_vfifo_fr
	wire  [383:0] p0_phy_phy_read_fifo_q;                      // p0:phy_read_fifo_q -> s0:phy_read_fifo_q
	...
	wire   [23:0] c0_afi_afi_wdata_valid;                      // c0:afi_wdata_valid -> m0:afi_wdata_valid
	wire  [383:0] c0_afi_afi_wdata;                            // c0:afi_wdata -> m0:afi_wdata
	wire    [3:0] c0_afi_afi_rst_n;                            // c0:afi_rst_n -> m0:afi_rst_n
	wire          c0_afi_afi_cal_req;                          // c0:afi_cal_req -> s0:afi_cal_req
	wire   [23:0] c0_afi_afi_dqs_burst;                        // c0:afi_dqs_burst -> m0:afi_dqs_burst
	wire   [51:0] c0_afi_afi_addr;                             // c0:afi_addr -> m0:afi_addr
	wire   [11:0] c0_afi_afi_ba;                               // c0:afi_ba -> m0:afi_ba
	wire   [47:0] c0_afi_afi_dm;                               // c0:afi_dm -> m0:afi_dm
