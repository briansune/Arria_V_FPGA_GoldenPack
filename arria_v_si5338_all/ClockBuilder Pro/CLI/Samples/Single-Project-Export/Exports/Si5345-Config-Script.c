 ...
 * Created By:                                         CBProProjectRegistersExport v2.23.5 [2018-05-02]
 * Timestamp:                                          2018-05-02 10:37:47 GMT-05:00
 *
 ...
 * ========
 * Part:         Si5345A Rev D
 * Project File: Si5345-Project.slabtimeproj
 * Design ID:    <none>
 * Created By:   CBProProjectRegistersExport v2.23.5 [2018-05-02]
 * Timestamp:    2018-05-02 10:37:47 GMT-05:00
 * 
 ...
 * - OUT0 [161.132812... MHz] and OUT1 [625 MHz] may have coupling [2]
 * 
 * Notes:
 ...
 * 
 * * Based on your calculated frequency plan, a Si5345A grade device is
 ...
 *          Enabled, LVDS 2.5 V
 *    OUT3: Unused
 *    OUT4: 168.041015625 MHz [ 168 + 21/512 MHz ]
 *          [ 39813.2*255/236/256M ]
 *          Enabled, LVDS 2.5 V
 *    OUT5: 672.1640625 MHz [ 672 + 21/128 MHz ]
 *          [ OUT4*4 ]
 *          Enabled, LVDS 2.5 V
 *    OUT6: 174.7030837004405286... MHz [ 174 + 798/1135 MHz ]
 *          [ 255*9953.28/(16*4*227)M ]
 *          Enabled, LVDS 2.5 V
 *    OUT7: Unused
 *    OUT8: 155.52 MHz [ 155 + 13/25 MHz ]
 *          Enabled, LVDS 2.5 V
 ...
 * 
 * Fvco = 13.68576 GHz [ 13 + 2143/3125 GHz ]
 * Fpfd = 1.944 MHz [ 1 + 118/125 MHz ]
 * Fms0 = 1.24416 GHz [ 1 + 763/3125 GHz ]
 * Fms1 = 1.25 GHz [ 1 + 1/4 GHz ]
 * Fms2 = 1.344328125 GHz [ 1 + 22037/64000 GHz ]
 * Fms3 = 322.265625 MHz [ 322 + 17/64 MHz ]
 * Fms4 = 698.8123348017621145... MHz [ 698 + 922/1135 MHz ]
 * 
 * P dividers:
 *    P0  = 10
 *    P1  = 10
 ...
 *       OUT9: 622.08 MHz [ 622 + 2/25 MHz ]
 *    N1:
 *       Value: 10.948608 [ 10 + 14822/15625 ]
 *       Skew:  0.000 s
 *       OUT1: 625 MHz
 *       OUT2: 156.25 MHz [ 156 + 1/4 MHz ]
 *    N2:
 *       Value: 10.1803717005474388... [ 10 + 129322/716975 ]
 *       Skew:  0.000 s
 *       OUT4: 168.041015625 MHz [ 168 + 21/512 MHz ]
 *       OUT5: 672.1640625 MHz [ 672 + 21/128 MHz ]
 *    N3:
 *       Value: 42.467328 [ 42 + 7302/15625 ]
 *       Skew:  0.000 s
 *       OUT0: 161.1328125 MHz [ 161 + 17/128 MHz ]
 *    N4:
 *       Value: 19.5843137254901960... [ 19 + 149/255 ]
 *       Skew:  0.000 s
 *       OUT6: 174.7030837004405286... MHz [ 174 + 798/1135 MHz ]
 * 
 * R dividers:
 ...
 * Airflow:  None
 * 
 * Total Power: 1.202 W, On Chip Power: 1.154 W, Tj: 95 °C
 * 
 *                 Frequency  Format   Voltage   Current     Power
 *         -----------------  ------  --------  --------  --------
 * VDD                                   1.8 V  261.8 mA    471 mW
 * VDDA                                  3.3 V  117.4 mA    387 mW
 * VDDO0   161.132812... MHz  LVDS       2.5 V   16.0 mA     40 mW
 * VDDO1             625 MHz  LVDS       2.5 V   19.1 mA     48 mW
 * VDDO2          156.25 MHz  LVDS       2.5 V   15.9 mA     40 mW
 * VDDO3              Unused                                      
 * VDDO4   168.041015... MHz  LVDS       2.5 V   16.0 mA     40 mW
 * VDDO5   672.164062... MHz  LVDS       2.5 V   19.4 mA     48 mW
 * VDDO6   174.703083... MHz  LVDS       2.5 V   16.1 mA     40 mW
 * VDDO7              Unused                                      
 * VDDO8          155.52 MHz  LVDS       2.5 V   15.9 mA     40 mW
 * VDDO9          622.08 MHz  LVDS       2.5 V   19.0 mA     48 mW
 *                                              --------  --------
 *                                       Total  516.6 mA   1.202 W
 * 
 * Note:
 * 
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256   25395              0x00006333       
 ...
 * 0x030D[43:0]  N1_NUM                 44845498368        0x00A71000000    
 * 0x0313[31:0]  N1_DEN                 4096000000         0xF4240000       
 * 0x0317[0]     N1_UPDATE              0                  0x0              
 * 0x0318[43:0]  N2_NUM                 29896998912        0x006F6000000    
 * 0x031E[31:0]  N2_DEN                 2936729600         0xAF0AF000       
 * 0x0322[0]     N2_UPDATE              0                  0x0              
 * 0x0323[43:0]  N3_NUM                 173946175488       0x02880000000    
 * 0x0329[31:0]  N3_DEN                 4096000000         0xF4240000       
 * 0x032D[0]     N3_UPDATE              0                  0x0              
 * 0x032E[43:0]  N4_NUM                 83785416704        0x01382000000    
 * 0x0334[31:0]  N4_DEN                 4278190080         0xFF000000       
 ...
 * 0x0532[23:0]  HOLD_15M_CYC_COUNT     858                0x00035A         
