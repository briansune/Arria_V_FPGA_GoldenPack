 ...
 * Timestamp:                                          2018-05-02 10:37:24 GMT-05:00
 *
 ...
 * ========
 * Part:         Si5347A Rev D
 * Project File: Output\P1-Project.slabtimeproj
 * Design ID:    <none>
 * Created By:   CBProFOTF1 v2.23.5 [2018-05-02]
 * Timestamp:    2018-05-02 10:37:24 GMT-05:00
 * 
 ...
 *          Enabled, LVDS 2.5 V
 *          DSPLL A
 *    OUT1: 644.53125 MHz [ 644 + 17/32 MHz ]
 *          Enabled, LVDS 2.5 V
 *          DSPLL A
 ...
 * Frequency Plan
 * ==============
 * Fvco = 13.5 GHz [ 13 + 1/2 GHz ]
 * MXAXB = 281.25 [ 281 + 1/4 ]
 * 
 * DSPLL A:
 *    Fpfd = 40 kHz
 *    Fdco = 1.2890625 GHz [ 1 + 37/128 GHz ]
 *    I/O Delay not enabled
 *    MA = 32226.5625 [ 32226 + 9/16 ]
 *    N0 = 10.4727272727272727... [ 10 + 26/55 ]
 *    Nominal Bandwidth:
 *      Desired: 40.000 Hz
 *      Actual:  48.926 Hz
 *      Coefficients:
 ...
 *    N1 = 10.0421911503190487... [ 10 + 1210/28679 ]
 *    Nominal Bandwidth:
 *      Desired: 40.000 Hz
 *      Actual:  51.671 Hz
 *      Coefficients:
 ...
 *    I/O Delay not enabled
 *    MC = 31104
 *    N2 = 10.8506944444444444... [ 10 + 245/288 ]
 *    Nominal Bandwidth:
 *      Desired: 40.000 Hz
 *      Actual:  46.747 Hz
 *      Coefficients:
 ...
 *    I/O Delay not enabled
 *    MD = 29700
 *    N3 = 11.3636363636363636... [ 11 + 4/11 ]
 *    Nominal Bandwidth:
 *      Desired: 40.000 Hz
 *      Actual:  44.084 Hz
 *      Coefficients:
 ...
 * Airflow:  None
 * 
 * Total Power: 1.331 W, On Chip Power: 1.283 W, Tj: 98 °C
 * 
 *                 Frequency  Format   Voltage   Current     Power
 *         -----------------  ------  --------  --------  --------
 * VDD                                   1.8 V  329.2 mA    593 mW
 * VDDA                                  3.3 V  120.4 mA    397 mW
 * VDDO0   161.132812... MHz  LVDS       2.5 V   16.0 mA     40 mW
 * VDDO1       644.53125 MHz  LVDS       2.5 V   19.2 mA     48 mW
 ...
 * 0x002E[15:0]  LOS0_TRG_THR                2700               0x0A8C           
 * 0x0030[15:0]  LOS1_TRG_THR                2700               0x0A8C           
 * 0x0032[15:0]  LOS2_TRG_THR                2700               0x0A8C           
 * 0x0034[15:0]  LOS3_TRG_THR                2700               0x0A8C           
 * 0x0036[15:0]  LOS0_CLR_THR                2700               0x0A8C           
 * 0x0038[15:0]  LOS1_CLR_THR                2700               0x0A8C           
 * 0x003A[15:0]  LOS2_CLR_THR                2700               0x0A8C           
 * 0x003C[15:0]  LOS3_CLR_THR                2700               0x0A8C           
 ...
 * 0x00A4[28:0]  LOL_CLR_DELAY_DIV256_PLLA   25273              0x000062B9       
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256_PLLB   25236              0x00006294       
 * 0x00AE[28:0]  LOL_CLR_DELAY_DIV256_PLLC   25305              0x000062D9       
 * 0x00B3[28:0]  LOL_CLR_DELAY_DIV256_PLLD   25348              0x00006304       
 ...
 * 0x0112[2]     OUT1_RDIV_FORCE2            1                  0x1              
 ...
 * 0x0308[31:0]  N0_DEN                      3690987520         0xDC000000       
 * 0x030C[0]     N0_UPDATE                   0                  0x0              
 * 0x030D[43:0]  N1_NUM                      37748736000        0x008CA000000    
 * 0x0313[31:0]  N1_DEN                      3759013888         0xE00E0000       
 * 0x0317[0]     N1_UPDATE                   0                  0x0              
 * 0x0318[43:0]  N2_NUM                      26214400000        0x0061A800000    
 * 0x031E[31:0]  N2_DEN                      2415919104         0x90000000       
 * 0x0322[0]     N2_UPDATE                   0                  0x0              
 * 0x0323[43:0]  N3_NUM                      33554432000        0x007D0000000    
 * 0x0329[31:0]  N3_DEN                      2952790016         0xB0000000       
 ...
 * 0x0415[55:0]  M_NUM_PLLA                  69206016000000     0x003EF148000000 
 ...
 * 0x0489[12:0]  PFD_EN_DELAY_PLLA           672                0x02A0           
 ...
 * 0x0589[12:0]  PFD_EN_DELAY_PLLB           672                0x02A0           
 ...
 * 0x0689[12:0]  PFD_EN_DELAY_PLLC           672                0x02A0           
 ...
 * 0x0789[12:0]  PFD_EN_DELAY_PLLD           672                0x02A0           
